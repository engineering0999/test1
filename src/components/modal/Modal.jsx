...
export default function Modal({ name,  phoneNumber, setName,  setPhoneNumber, buyNow }) {
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                ...
                                                <form className="space-y-4 md:space-y-6" action="#">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input value={phoneNumber} onChange={(e)=>setPhoneNumber(e.target.value)} type="tel" name="mobileNumber" id="mobileNumber" className=" border outline-0 border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-100" required />
                                                        </div>
