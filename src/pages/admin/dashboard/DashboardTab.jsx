...
function DashboardTab() {
    ...
    const { mode, product, edithandle, deleteProduct, order, user,jobs,deleteJob } = context
            ...
            <div className="container mx-auto">
                <div className="tab container mx-auto ">
                    <Tabs defaultIndex={0} className=" " >
                        <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-8 mx-10   md:justify-center mb-10 ">
                            <Tab>
                                <button type="button" className="font-medium border-b-2 border-pink-500  text-pink-500   text-xl  text-center ">
                                    <div className="flex gap-2 items-center">
                                        <MdOutlineProductionQuantityLimits />Products</div> </button>
                            </Tab>
                            
                            <Tab>
                                <button type="button" className="font-medium border-b-2 border-pink-500   text-xl  text-pink-500 text-center ">
                                    <div className="flex gap-2 items-center">
                            ...
                            <div className='  px-4 md:px-0 mb-16'>
                                ...
                                <div className="relative overflow-x-auto ">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                        ...
                                        {jobs.map((item, index) => {
                                            const { company ,title, location, type, salary, exp, link } = item;
                                            return (
                                                <tbody className=''>
                                                    <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                        <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
